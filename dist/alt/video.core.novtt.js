...
(function (global, factory) {
  ...
  function (_Button) {
    ...
    _proto.useCustomClickHandler = function useCustomClickHandler(handler) {
      this.disable();
  ...
  function (_Component) {
    ...
    _proto.handleTechDRMSuccess_ = function handleTechDRMSuccess_() {
    ...
    _proto.resetSource = function resetSource() {
